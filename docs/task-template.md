...
- 커밋 또는 푸시 이후의 계획 문서는 당시 합의 기록으로 보고, 의미 있는 변경은 기존 내용을 덮어쓰기보다 변경 내역이나 결정 기록으로 추가한다
- 계획과 실제 결과가 달라진 경우 결과 섹션에 계획과 달라진 점과 사유를 남긴다
- 작업 범위가 크게 바뀐 경우 기존 계획을 보존하고 새 계획 문서 또는 버전 구분으로 분리한다
